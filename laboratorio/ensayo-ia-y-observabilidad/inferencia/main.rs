...
fn main()->Result<(),Box<dyn std::error::Error+Send+Sync>>{
 ...
 println!("{}",serde_json::json!({"tipo":"modelo_real","segundos_intervalo_completo":segundos_observacion,"telemetria":a[4],"salida":s,"contrato":contrato,"alcance_off":"coste; sin cobertura OpenTelemetry"}));
