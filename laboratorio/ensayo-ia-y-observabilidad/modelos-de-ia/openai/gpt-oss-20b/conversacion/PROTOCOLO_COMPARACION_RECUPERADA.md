...
## Ampliación de procedencia, 16:09 UTC

Se recuperó íntegramente la tercera exportación `f39a2a05-22bc-40e5-9215-89d9b222d5f0.json` (1110 líneas). Contiene un único turno terminado normalmente, con el mismo identificador de petición y el mismo objeto de turno que R01-01. Sus 50 sucesos coinciden exactamente con el prefijo de 50 sucesos de la exportación posterior de nueve turnos. Por tanto, se han localizado tres archivos, pero solo dos rondas y once preguntas distintas. No se duplica R01-01 ni se modifica el banco. La conciliación estructural figura en `CONCILIACION_TERCERA_EXPORTACION.json`. Esta ampliación se registra antes de observar las respuestas comparativas nuevas.
