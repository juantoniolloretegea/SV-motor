...
**Estado de esta revisión:** 0.1.2 compilada, con pruebas de reinicio y comprobación HTTP local superadas. El servicio se inició el 22 de septiembre de 2026; el acceso externo de navegador permanece pendiente de verificación. [Resultados y límites](verificacion-0.1.2/INFORME.md). La reanudación del Codespace no acredita que el servicio de conversación esté iniciado.
