# Dependencias, recursos y habilitación posterior
...
3. Registrar versiones, órdenes y resultados por fase. Resolver lock no es compilar; compilar no es ejecutar; ejecutar el banco no acredita modelo. Compilar --locked y correr primero cinco tests de frontera, 35 complementarios y 24 controles originales.
4. Construir sin feature inferencia y probar testigos N01–N17 en directorios nuevos, un intento activo; demostrar cierre, persistencia, recuperación y autenticación. Si falla, detener; corrección y nueva autorización antes de repetir campaña, nunca repetir modelo por defecto.
