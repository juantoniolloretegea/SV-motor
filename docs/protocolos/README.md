# Protocolos del frente IA del Sistema Vectorial SV
...
Carpeta de contratos mínimos para actores auxiliares, extractores, capas visuales y reglas de no fabricación de certeza.
